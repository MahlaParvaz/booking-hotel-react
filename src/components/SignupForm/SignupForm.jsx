...
const SignupForm = () => {
  const { signup, checkUsernameExistence } = useAuth();
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <div className="w-full flex items-center justify-center mb-8 ">
      ...
      >
        ...
        <div className="formControll flex  items-center  mb-5 w-[350px]">
          <label htmlFor="terms" className="mr-4 ">
          ...
          <input
            ...
            {...register('terms', {
              pattern: {
                message: 'Invalid agreement terms',
              },
            })}
          />
          <p className="error -text--rose-500 text-[13px] font-semibold py-1 px-2">
