...
function BookmarkLayout() {
  ...
  return (
    <div className=" flex z-50 justify-center items-center w-full  mb-5 ">
      <div className="appLayout mobile:mt-[110px]  laptop:mt-[6rem] tablet:mt-[6rem] mobile:flex-col w-[90%] flex laptop:flex-row tablet:flex-row  justify-between laptop:items-stretch tablet:items-stretch mobile:items-center laptop:h-screen tablet:h-screen mobile:h-[180vh]  ">
